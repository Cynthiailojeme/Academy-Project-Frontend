        ...
        <form>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Question {{ this.quiz.length }}</label>
                    <div class="files" v-if="!first.img" @click="clicked">
                        <p><img src="../assets/plus.svg" @click="clicked" class="icon">Choose File</p>
                    </div>
                    <div v-else>
                        <img :src="first.img" class="fileimg"/>
                ...
                <div class="form-group col-md-6">
                    <label>Set Time (In Minutes)</label><br>
...
this.myWidget=  cloudinary.createUploadWidget({
   ...
   (error, result) => {
    ...
    if (!error && result && result.event === "success") { 
      ...
      this.first.img = result.info.url;
      console.log(this.first.img)
       }
      else {
          console.log(error);
      }
...
methods: {
    ...
    addPost (){
        ...
        console.log(oneset)
            this.$http.post('http://localhost:3000/api/questionset/add', oneset)
      	.then(response =>{
            this.nameOfSet = "",
            this.duration = "",
            this.dateOfAsess = "",
