        ...
        <table class="table table-borderless">
            ...
            <tbody>
                <tr v-for="questionset in questionsets" :key="questionset._id">
                    ...
                    <td>
                        <router-link :to="{name:'edit', params:{id: questionset._id}}" class="link">
                            <i class="fa fa-pencil-square-o" aria-hidden="true" title="edit"></i> &nbsp; &nbsp;
                        </router-link>
                        <i class="fa fa-trash" aria-hidden="true" title="delete" @click="del(questionset)"></i></td>
                </tr>
            </tbody>
        </table>
    </div>
